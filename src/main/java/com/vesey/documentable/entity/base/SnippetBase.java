...
/**
 * SnippetBase - This file has been auto-generated - do not edit (changes will be overwritten)
 */

@MappedSuperclass
@Table(name = "snippet", catalog = "documentable")

public abstract class SnippetBase extends BaseEntity implements java.io.Serializable {
	...
	protected Snippet parent;

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "snippettemplate", nullable = false)
	protected Snippettemplate snippettemplate;
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof com.vesey.documentable.entity.base.SnippetBase)) {
			return false;
		}

		com.vesey.documentable.entity.base.SnippetBase castOther = (com.vesey.documentable.entity.base.SnippetBase) other;
